<?php 
	/* Template Name: My Account Student Edit Page */ 
	get_header(); 
...
<section class="section my-account-bg add-drtails-main ">
      ...
      <div class="row add-drtails">
        <div class="col-lg-8 col-md-10 col-sm-12">
          <div class="back-btn mb-3">
            <a href="<?=home_url('/my-account/students')?>"><button type="button" class="back-btn"><img src="<?=get_stylesheet_directory_uri()?>/assets/img/back-btn.png" class="img-fluid"></button></a>
          </div>
            ...
            <form method="post" class="custom-reg-form custom-add-form-inner" id="customregform"  enctype="multipart/form-data" >
              ...
              <div class="row">
                <div class="col-sm-4 mb-3">
                    <input type="text" name="custom_fname" id="custom_fname" value="<?=$user_info->first_name?>" onkeydown="return /[a-z]/i.test(event.key)" placeholder="First Name" required>
                </div>
                <div class="col-sm-4 mb-3">
              ...
              <div class="row">
				...
				<div class="col-sm-4 mb-3">
                    <input type="text" name="school_uid" id="school_uid" value="<?=get_user_meta($user_info->ID,'school_uid',true)?>" placeholder="School ID" readonly>
                </div>
				<div class="col-sm-4 mb-3">
  ...
  title="Must contain minimum eight characters, at least one uppercase letter, one lowercase letter, one number and one special character" id="custom_pass" placeholder="password">
              ...
              <div class="row">
                ...
                <div class="col-sm-4 mb-3">
                  <input type="number" max="12" min="1" id="class_id"  name="class_id" value="<?=get_user_meta($user_info->ID,'class_id',true)?>" placeholder="Class">
                </div>
                <div class="col-sm-4 mb-3">
			  ...
			  <input type="hidden" name="redirect_url" id="redirect_url" value="<?=home_url()?>/my-account/edit-student?key=<?=base64_encode($user_info->ID)?>" />
