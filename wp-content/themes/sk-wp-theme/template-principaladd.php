<?php 
	/* Template Name: My Account Principal Add Page */ 
	get_header(); 
  ...
  title="Must contain minimum eight characters, at least one uppercase letter, one lowercase letter, one number and one special character"  id="custom_pass_confirm" placeholder="Confirm Your Password" required>
              ...
              <div class="row">
                ...
                <div class="col-sm-4 mb-3" style="display:none">
                  <input type="hidden" max="12" min="1" id="class_id"  name="class_id" placeholder="Class">
                </div>
                <div class="col-sm-4 mb-3" style="display:none">
                  <input type="hidden" id="section"  onkeydown="return /[a-z]/i.test(event.key)" name="section"  placeholder="Section">
                </div>
			  ...
			  <input type="hidden" name="register_as" value="principal" />
			  <input type="hidden" name="redirect_url" id="redirect_url" value="<?=home_url('/my-account/principals')?>" />
