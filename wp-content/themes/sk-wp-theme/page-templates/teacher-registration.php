	...
	<section class="section position-relative overflow-hidden registration-section">
		...
		<div class="container position-relative">
			<div class="form-block-1">
				...
				<?php echo do_shortcode("[user_registration_form id='534']"); ?>
				<div class="create-acc-wrap"><span>Once registered <a class="create-acc-link" href="https://18.220.246.60/teep/login/?user=teacher&dashboard=teacher-dashboard">Click here to login</a></span></div>
			</div>
		</div>
	</section>
