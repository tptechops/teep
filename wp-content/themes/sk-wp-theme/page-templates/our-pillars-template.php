...
<main id="primary" class="site-main">
	<section class="inn-banner type-1 what-we-do-banner bg-007CC3 mb-5"
		style="background-image: url(https://18.220.246.60/teep/wp-content/uploads/2022/11/Our-Pillars-banner.jpg)">
		<div class="container">
	...
	<section class="our-pillars py-5">
		...
		<div class="container">
					...
					<div class="lgcy-list lgcy-list-piller">
						...
						<div class="lgcy-item lgcy-list-pillars">
							...
							<div class="lgcy-item-inn">
								<div class="lgcy-crcl our-piller-circle">
									<img class="lgcy-icon"
										src="https://18.220.246.60/teep/wp-content/uploads/2022/09/Frame.png" alt="">
								</div>
						...
						<div class="lgcy-item lgcy-list-pillars">
							<div class="lgcy-item-inn">
								<div class="lgcy-crcl our-piller-circle">
									<img class="lgcy-icon"
										src="<?php echo home_url(); ?>/wp-content/uploads/2022/09/Vector-1.png" alt="">
								</div>
								<h4 class="fs-28 fw-500 lgcy-title">
									IMPROVEMENT
								</h4>
						...
						<div class="lgcy-item lgcy-list-pillars">
							<div class="lgcy-item-inn">
								<div class="lgcy-crcl our-piller-circle">
									<img class="lgcy-icon"
										src="<?php echo home_url(); ?>/wp-content/uploads/2022/09/Group-2.png" alt="">
								</div>
								<h4 class="fs-28 fw-500 lgcy-title">
									ASSESSMENT
								</h4>
				...
				<div class="container">
					...
					<div class="section-content afe-section-content-1">
						<div class="row gx-5 gy-5">
							...
							<div class="col-lg-6">
								<div class="image-wrap">
									<img class="op-img" src="<?php echo the_field('op_image_2'); ?>" alt=""
										width="100%">
								</div>
							</div>
			...
			<div class="op-cont-row pb-100">
				...
				<div class="section-title text-center">
								<h2 class="fs-50 fw-500">
									<?php the_field('op_title_4'); ?>
								</h2>
							</div>

							<div class="col-lg-12">
								<div class="content-wrap">
									<div class="op-cont fs-28 fw-300 mar-btn"><?php the_field('op_content_4'); ?></div>
								</div>
							</div>
