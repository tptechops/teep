<?php 
	/* Template Name: My Account Student Add Page */ 
	get_header(); 
...
<section class="section my-account-bg add-drtails-main">
            ...
            <form method="post" class="custom-reg-form custom-add-form-inner" id="customregform"  enctype="multipart/form-data" >
              ...
              <div class="row">
				...
				<div class="col-sm-4 mb-3" style="display:none;">
                    <input type="text" name="school_uid" id="school_uid" placeholder="School ID">
                </div>
				<div class="col-sm-4 mb-3">
  ...
  title="Must contain minimum eight characters, at least one uppercase letter, one lowercase letter, one number and one special character" id="custom_pass_confirm" placeholder="Confirm Your Password" required>
                ...
                <div class="col-sm-4 mb-3">
                  <input type="number" max="12" min="1" id="class_id"  name="class_id" placeholder="Class">
                </div>
                <div class="col-sm-4 mb-3">
                  <input type="text" id="section"  name="section" placeholder="Section" onkeydown="return /[a-z]/i.test(event.key)">
                </div>
			  ...
			  <input type="hidden" name="redirect_url" id="redirect_url" value="<?=home_url('/my-account/students')?>" />
